 ...
 */
#define X_DRIVER_TYPE  DRV8825 // xxxx
#define Y_DRIVER_TYPE  DRV8825 // xxxx
#define Z_DRIVER_TYPE  DRV8825 // xxxx
...
#define E0_DRIVER_TYPE DRV8825 // xxxx
 ...
 */
#define PIDTEMP // xxxx           // See the PID Tuning Guide at https://reprap.org/wiki/PID_Tuning
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  40.34,  22.20 } // xxxx
    #define DEFAULT_Ki_LIST {   3.40,   1.08 } // xxxx
    #define DEFAULT_Kd_LIST { 119.78, 114.00 } // xxxx
  #else
    #define DEFAULT_Kp  40.34 // xxxx
    #define DEFAULT_Ki   3.40 // xxxx
    #define DEFAULT_Kd 119.78 // xxxx
  #endif
#else
...
#define PIDTEMPBED // xxxx
  ...
  #define DEFAULT_bedKp 4.73 // xxxx
  #define DEFAULT_bedKi 0.13 // xxxx
  #define DEFAULT_bedKd 112.98 // xxxx

  // FIND YOUR OWN: "M303 E-1 C8 S90" to run autotune on the bed at 90 degreesC for 8 cycles.
#else
  #define BED_LIMIT_SWITCHING //xxxx  // Keep the bed temperature within BED_HYSTERESIS of the target
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 500 } // xxxx
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 // xxxx
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save flash. // xxxx
...
//
#define REPRAP_DISCOUNT_SMART_CONTROLLER // xxxx
